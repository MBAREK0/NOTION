...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    ...
    <div class="h-10 flex items-center space-x-2 mb-10">
        ...
        <ul class="space-y-2 font-medium mt-[100px] !important">
            ...
            <c:if test="${sessionScope.user.role == 'manager'}">
                <li>
                    <a href="<%= request.getContextPath() %>/inbox" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
