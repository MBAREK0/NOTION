                          ...
                          <div id="dropdown${task.id}" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton${task.id}">
                              <li class="text-center">
                                <button class="w-full px-4 py-2 text-sm text-yellow-600 hover:bg-gray-100 dark:hover:bg-gray-700 font-bold" type="submit" name="status" value="pending">Pending</button>
                              </li>
                              <li class="text-center">
                                <button class="w-full px-4 py-2 text-sm text-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 font-bold" type="submit" name="status" value="in_progress">In Progress</button>
                              </li>
                              <li class="text-center">
                                <button class="w-full px-4 py-2 text-sm text-green-600 hover:bg-gray-100 dark:hover:bg-gray-700 font-bold" type="submit" name="status" value="completed">Completed</button>
                              </li>
                              <li class="text-center">
                                <button class="w-full px-4 py-2 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-700 font-bold" type="submit" name="status" value="overdue">Overdue</button>
                              </li>
                            </ul>
                          </div>
                        </form>
